$(document).ready(function () {
  ...
  function canPlayModalResource() {
    const dataSrc = [
      { data: "video", btn_name: "infoRes_btn" },
      { data: "audio", btn_name: "audioRes_btn" },
    ];
    dataSrc.forEach((element) => {
      if (
        ...
        $("#modal_" + currentIndex)
          .find("." + element.btn_name)
          .addClass("d-none");
      } else {
        $("#modal_" + currentIndex)
          .find("." + element.btn_name)
          .removeClass("d-none");
        element.btn_name == "audioRes_btn"
          ? $("#modal_" + currentIndex)
              .find("." + element.btn_name)
              .removeClass("d-none")
          : $(".modalVideo video").attr(
              "src",
              $("#modal_" + currentIndex)
                .find(".modal-footer")
                .data(element.data)
  ...
  $(".audioRes_btn").on("click", function () {
    let audio_src = $("#modal_" + currentIndex)
      .find(".modal-footer")
      .data("audio");
    playSound(audio_src);
  });
...
$(".modal-header").append(
  `<button type="button" class="btn-close text-white d-flex align-items-center justify-content-center" data-bs-dismiss="modal" aria-label="Close"><i class="bi bi-x-lg"></i></button>`
);
$(".modal-footer")
  .append(`<div class="audioRes_btn_wrapper wow fadeInLeft" data-duration>
